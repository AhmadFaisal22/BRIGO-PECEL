...
<p class="mb-4">Cash Recycle Machine</p>

<!-- DataTales Example -->
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">DataTables CRM Error</h6>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead class="thead-light">
          <button type="button" class="btn btn-warning"><i class="fas fa-fw fa-plus-square"></i> Tambah Data</button><br>
