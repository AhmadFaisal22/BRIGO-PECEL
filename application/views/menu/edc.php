...
<p class="mb-4">Electronic Debit Cash </p>


<!-- DataTales Example -->
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-success">DataTables EDC Error</h6>
  </div>
  <div class="card-body">
    ...
    <?= $this->session->flashdata('message');?>
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead class="thead">
          <a href="" class="btn btn-success" data-toggle="modal" data-target="#newDataAtm"><i class="fas fa-fw fa-plus-square"></i> Tambah Data</a><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newDataAtmLabel">Form Input Data EDC</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?= base_url('menu/edc');?>" method="post">
