...
<p class="mb-4">Automated Teller Machine</p>
    ...
    <?= $this->session->flashdata('message');?>
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead class="thead-dark">
          <a href="" class="btn btn-primary" data-toggle="modal" data-target="#newDataAtm"><i class="fas fa-fw fa-plus-square"></i> Tambah Data</a><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newDataAtmLabel">Form Input Data ATM</h5>
